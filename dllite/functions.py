import numpy as np
import dllite
from dllite.core import Function, Variable
from dllite.core import as_variable, as_array
from dllite import utils
from dllite import cuda
...
class GetItem(Function):
    ...
    def backward(self, gy):
        x, = self.inputs
        f = GetItemGrid(self.slices, x.shape)
        return f(gy)
